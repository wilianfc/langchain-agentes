...
\chapterepigraph{``I know you, I know your names.''}{\textit{Book of the Dead}, ``The Address to the Gods''.}
{\small\itshape\color{AccentGray}
No rito funer\'{a}rio eg\'{i}pcio, nomear os guardi\~{o}es era o ato que abria passagem --- quem conhecia os nomes detinha poder sobre eles. Paulo Freire recuperou essa intui\c{c}\~{a}o no contexto pedag\'{o}gico: nomear o mundo \'{e} o ato inaugural da consci\^{e}ncia cr\'{i}tica, e o m\'{e}todo Freire come\c{c}a precisamente pelo \textit{universo vocabular} do pr\'{o}prio aprendiz --- palavras que emergem de sua realidade concreta e carregam em si toda a sua hist\'{o}ria~\cite{freire1968pedagogia}. Personas e \textit{Digital Twins} s\~{a}o o an\'{a}logo t\'{e}cnico desse princ\'{i}pio: n\~{a}o h\'{a} segmenta\c{c}\~{a}o \'{u}til sem que o sistema conhe\c{c}a o perfil, o hist\'{o}rico e os padr\~{o}es de comportamento de quem pergunta.\par}
\vspace{0.6em}
% ---------------------------------------------------------------
