...
\chapterepigraph{``The machine is only a tool after all, which can help humanity progress faster by taking some of the burdens of calculations and interpretations off its back.''}{Isaac Asimov, \textit{I, Robot} (1950).}
{\small\itshape\color{AccentGray}
Asimov lembrava que a m\'{a}quina serve ao humano, n\~ao o contr\'{a}rio. Numa esteira de CI/CD, essa distin\c{c}\~ao \'{e} testada a cada ciclo: a tenta\c{c}\~ao de deixar que a automa\c{c}\~ao decida sem supervis\~ao humana --- promover para produ\c{c}\~ao sem revis\~ao, aprovar \textit{gates} sem leitura cr\'{i}tica, confiar no pipeline como se ele fosse infalível --- \'{e} o momento em que a ferramenta come\c{c}a a conduzir quem deveria conduzi-la. Este cap\'{i}tulo trata de esteiras que automatizam sem abdicar de responsabilidade.\par}
\vspace{0.6em}
% ---------------------------------------------------------------
