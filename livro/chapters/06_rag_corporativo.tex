...
\chapterepigraph{``All that is solid melts into air.''}{Karl Marx e Friedrich Engels, \textit{Manifesto of the Communist Party} (1848).}

{\small\itshape\color{AccentGray}
Marx e Engels descreviam as transforma\c{c}\~oes do capitalismo industrial do s\'{e}culo XIX; os dados corporativos de hoje passam por uma metamorfose estruturalmente an\'{a}loga. Documentos antes s\'{o}lidos --- contratos em PDF, regulamentos em Word, atas de reuni\~ao --- dissolvem-se em fragmentos vetorizados, flu\'{i}dos, recuper\'{a}veis sob demanda. O s\'{o}lido torna-se contexto; o est\'{a}tico torna-se conhecimento ativo. A quest\~ao, como em Marx, \'{e} quem governa essa transforma\c{c}\~ao e em benef\'{i}cio de quem.\par}
\vspace{0.6em}
...
\begin{quote}\itshape
\textbf{Onde estamos na hist\'oria:} loop interno, RAG em escala corporativa.
O cap\'itulo~5 construiu um pipeline RAG minimal com FAISS local.
Agora o sistema cresce: fontes heterog\^eneas (documentos e entrevistas),
\'indice OpenSearch para produ\c{c}\~ao e governan\c{c}a de dados
sens\'iveis. Este \'e o RAG que o loop externo
avaliar\'a nos cap\'itulos 11--14.
\end{quote}
