"""Validacoes Sprint A ? executa sem AWS."""
...
def test_faiss():
    ...
    assert I[0][0] == 0, "Doc mais proximo deve ser o proprio"
    print(f"[V2] FAISS OK ? {index.ntotal} vetores, top-3 indices: {I[0].tolist()}")

    # verificar indice persistido
...
if __name__ == "__main__":
    print("=" * 60)
    print("Sprint A ? Validacoes")
    print("=" * 60)
    test_faiss()
    asyncio.run(test_mcp_tools())
    test_otel()
    print("=" * 60)
    print("Todas as validacoes concluidas.")
